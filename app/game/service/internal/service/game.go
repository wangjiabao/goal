...
func NewGameService(gc *biz.GameUseCase, dc *biz.DisplayGameUseCase, gsc *biz.GameSortUseCase, logger log.Logger) *GameService {
	return &GameService{gc: gc, dc: dc, gsc: gsc, log: log.NewHelper(logger)}
}
