...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	playUseCase := biz.NewPlayUseCase(playRepo, playGameRelRepo, playSortRelRepo, playGameScoreUserRelRepo, playGameTeamGoalUserRelRepo, playGameTeamResultUserRelRepo, gameRepo, sortRepo, userBalanceRepo, userProxyRepo, userInfoRepo, transaction, logger)
