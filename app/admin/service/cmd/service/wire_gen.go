...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	playUseCase := biz.NewPlayUseCase(playRepo, playGameRelRepo, playSortRelRepo, playGameScoreUserRelRepo, gameRepo, sortRepo, userBalanceRepo, userProxyRepo, userInfoRepo, transaction, logger)
	...
	gameService := service.NewGameService(gameUseCase, sortUseCase, logger)
