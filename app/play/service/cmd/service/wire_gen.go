...
func wireApp(confServer *conf.Server, confData *conf.Data, auth *conf.Auth, logger log.Logger) (*kratos.App, func(), error) {
	...
	playUseCase := biz.NewPlayUseCase(playRepo, playGameRelRepo, systemConfigRepo, playSortRelRepo, playRoomRelRepo, roomUserRelRepo, userInfoRepo, roomRepo, gameRepo, sortRepo, playGameScoreUserRelRepo, playGameTeamSortUserRelRepo, playGameTeamGoalUserRelRepo, playGameTeamResultUserRelRepo, userBalanceRepo, userProxyRepo, transaction, logger)
